...
import { addContract } from '@/store/features/projects/projectsSlice'
import { isABI, isCode, remove0x, classNames } from '@/utils/common'
...
export default function AddContract() {
	...
	const onSubmit = (data: any) => {
		try {
			...
			}), router.push('/app/IoSanX696IQBDnOmIs/' + id))
		} catch (error) {
